/*   STEP 1   */
export const leagueID = "1180217703201075200"; // your league ID
...
export const managers = [
    {
      "roster": 1180217703201075200,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "name": "Tim",
