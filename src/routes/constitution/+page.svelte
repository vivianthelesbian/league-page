...
<div class="constitution">
    ...
    <p>5 Taxi Spots (Allows for Rookies and Sophomores)</p>
        ...
        <div class="subBlock">
            <table class="positionMaximums">
                ...
                <tr><td>TE</td><td class="right">20</td></tr>
                <tr><td>IDP</td><td class="right">20</td></tr>
                </tbody>
            </table>
        </div>
    ...
    <p>Trading of players and draft picks (up to 3 drafts away) are allowed. Trades will process immediately and will be reversed if vetoed under investigation for collusion. Tradable assets include players, draft picks, and FAAB $.</p>
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for the Monday of the week 11 games of the NFL season.</p>
    </div>
    ...
    <div class="subBlock">
        <p>We do not plan to hold veto rules barring collusion so these will be established on a situation-basis.</p>
    </div>
    ...
    <p>FAAB budgets will reset each season after the Rookie Draft and at the start of the Regular Season.</p>
    ...
    <p>Rookie drafts will consist of 4 round of drafting, with 5 minutes alotted for each pick.</p>
    ...
    <p>Along with filling their roster, managers should have their taxi full at the start of the season, even if a player may be elevated to the full roster mid-season.</p>
    ...
    <p>League dues are set at {dues}$. Beginning in 2026, dues are collected through <a href="https://www.leaguesafe.com/league/3949641">LeagueSafe</a> and collection will be sent out no later than the first of August. All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, a 10% penalty will be add to their payment and will go towards the payouts at the end of the year.</p>
